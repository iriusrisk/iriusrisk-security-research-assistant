...
CUSTOM_FIELD_EMB3D_TECHNIQUE = "emb3d_technique"
CUSTOM_FIELD_EMB3D_MITIGATION = "emb3d_mitigation"
...
OUTPUT_NAME = {
    ...
    'azure-security-benchmark': {'ref': 'azure-security-benchmark', 'name': 'Azure Security Benchmark'},
    'CIS AWS Standard': {'ref': 'CIS AWS Standard', 'name': 'CIS Amazon Web Services Foundations Benchmark Level 1'},
    'cis-amazon-web-services-three-tier-web-architecture-benchmark': {'ref': 'cis-amazon-web-services-three-tier-web-architecture-benchmark',
     'name': 'CIS Amazon Web Services Three-tier Web Architecture Benchmark Level 1'},
    'cis-amazon-web-services-three-tier-web-architecture-benchmark-level-2': {'ref': 'cis-amazon-web-services-three-tier-web-architecture-benchmark-level-2',
     'name': 'CIS Amazon Web Services Three-tier Web Architecture Benchmark Level 2'},
    'CIS-AWS-Standard-Level-2': {'ref': 'CIS-AWS-Standard-Level-2', 'name': 'CIS Amazon Web Services Foundations Benchmark Level 2'},
    'cis-azure-standard': {'ref': 'cis-azure-standard', 'name': 'CIS Microsoft Azure Foundations Benchmark Level 1'},
    'cis-azure-standard-level-2': {'ref': 'cis-azure-standard-level-2', 'name': 'CIS Microsoft Azure Foundations Benchmark Level 2'},
    'cis-gcp-standard': {'ref': 'cis-gcp-standard', 'name': 'CIS Google Cloud Platform Foundation Benchmark Level 1'},
    'cis-gcp-standard-level-2': {'ref': 'cis-gcp-standard-level-2', 'name': 'CIS Google Cloud Platform Foundation Benchmark Level 2'},
    'cis-kubernetes-level-1': {'ref': 'cis-kubernetes-level-1', 'name': 'CIS Kubernetes - Level 1'},
    'cis-kubernetes-level-2': {'ref': 'cis-kubernetes-level-2', 'name': 'CIS Kubernetes - Level 2'},
    'cis-oracle-cloud-level-1': {'ref': 'cis-oracle-cloud-level-1', 'name': 'CIS Oracle Cloud Infrastructure Foundations Level 1'},
    'cis-oracle-cloud-level-2': {'ref': 'cis-oracle-cloud-level-2', 'name': 'CIS Oracle Cloud Infrastructure Foundations Level 2'},
    'csa-api-security-guidelines': {'ref': 'csa-api-security-guidelines', 'name': 'CSA API Security Guidelines'},
    'csa-container-architectures': {'ref': 'csa-container-architectures',
     'name': 'CSA Best Practices for Implementing a Secure Application Container Architecture'},
    'cwe-top-25-dangerous-weaknesses': {'ref': 'cwe-top-25-dangerous-weaknesses', 'name': 'CWE Top 25 Most Dangerous Software Weaknesses'},
    'EU-GDPR': {'ref': 'EU-GDPR', 'name': 'EU-GDPR'},
    'fedramp-low-baseline': {'ref': 'fedramp-low-baseline', 'name': 'FedRAMP Low Baseline'},
    'fedramp-moderate-baseline': {'ref': 'fedramp-moderate-baseline', 'name': 'FedRAMP Moderate Baseline'},
    'hipaa-addressable': {'ref': 'hipaa-addressable', 'name': 'HIPAA Addressable'},
    'hipaa-required': {'ref': 'hipaa-required', 'name': 'HIPAA Required'},
    'iotsf-class-0': {'ref': 'iotsf-class-0', 'name': 'IoTSF Class 0'},
    'iotsf-class-1': {'ref': 'iotsf-class-1', 'name': 'IoTSF Class 1'},
    'iotsf-class-2': {'ref': 'iotsf-class-2', 'name': 'IoTSF Class 2'},
    'ISO/IEC 27002:2013': {'ref': 'ISO/IEC 27002:2013', 'name': 'ISO/IEC 27002:2013'},
    'iso-sae-21434': {'ref': 'iso-sae-21434', 'name': 'ISO/SAE 21434'},
    'Level 1 - Docker': {'ref': 'Level 1 - Docker', 'name': 'CIS Docker - Level 1'},
    'Level 1 - Linux Host OS': {'ref': 'Level 1 - Linux Host OS', 'name': 'CIS Docker Linux Host OS Level 1'},
    'Level 2 - Docker': {'ref': 'Level 2 - Docker', 'name': 'CIS Docker - Level 2'},
    'nist-800-190': {'ref': 'nist-800-190', 'name': 'NIST 800-190'},
    'NIST-Secure-Microservice-Strategies': {'ref': 'NIST-Secure-Microservice-Strategies',
     'name': 'NIST Security Strategies for Microservices-based Application Systems'},
    'owasp-api-security-top-10': {'ref': 'owasp-api-security-top-10', 'name': 'OWASP API Security Top 10'},
    'owasp-asvs4-level-1': {'ref': 'owasp-asvs4-level-1', 'name': 'OWASP-ASVS4-Level-1'},
    'owasp-asvs4-level-2': {'ref': 'owasp-asvs4-level-2', 'name': 'OWASP-ASVS4-Level-2'},
    'owasp-asvs5-level-1': {'ref': 'owasp-asvs5-level-1', 'name': 'OWASP-ASVS5-Level-1'},
    'owasp-asvs5-level-2': {'ref': 'owasp-asvs5-level-2', 'name': 'OWASP-ASVS5-Level-2'},
    'owasp-asvs5-level-3': {'ref': 'owasp-asvs5-level-3', 'name': 'OWASP-ASVS5-Level-3'},
    'OWASP-CSVS-L1': {'ref': 'OWASP-CSVS-L1', 'name': 'OWASP-CSVS-L1'},
    'OWASP-CSVS-L2': {'ref': 'OWASP-CSVS-L2', 'name': 'OWASP-CSVS-L2'},
    'OWASP-CSVS-L3': {'ref': 'OWASP-CSVS-L3', 'name': 'OWASP-CSVS-L3'},
    'owasp-docker-top-10-2018': {'ref': 'owasp-docker-top-10-2018', 'name': 'OWASP Docker Top 10 2018'},
    'owasp-kubernetes-top-10-2022': {'ref': 'owasp-kubernetes-top-10-2022', 'name': 'OWASP Kubernetes Top 10 2022'},
    ...
    'EU-CRA': {'ref': 'EU-CRA', 'name': 'EU Cyber Resilience Act'}
}
...
CRE_MAPPING_NAME = {
    ...
    "ISO 27001": "ISO 27001",
    "IEC62443-4-2-ICSA-500": "IEC62443-4-2-ICSA-500"
}
