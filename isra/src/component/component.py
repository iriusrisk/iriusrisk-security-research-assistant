...
def create_new_component(component_name, description, category):
    initialize_template()
...
def restart_component(remove_temporal_component):
...
def new():
    ...
    create_new_component(component_name, description, category)
...
def restart(force: Annotated[bool, typer.Option(help="Flag to remove temporal component automatically")] = False):
    ...
    restart_component(remove_temporal_component)
